...
import {IoPieCircleSharp} from "react-icons/io5"
import {IRiThumbUpFill,RiThumbDownFill, RiThumbUpFill} from "react-icons/ri"
...
export default React.memo(
  ...
  onAuthStateChanged(firebaseAuth,(currentUser)=>{
    if(currentUser) setEmail(current.email);
    else navigate("/login");
  });
            ...
            <div className='info-container flex column'>
              ...
              <div className='icons flex j-between'>
                <div className='controls flex'>
                  ...
                  <IoPieCircleSharp title="play" onClick={()=> navigate("/player")}/>
